...
ggscatter(kor_end, x = "vo2max_ml_min_kg_6x5", y = "phys_act", 
          ...
          xlab = "Endring i VO<sub>2maks</sub> (ml/kg/min<sup>)", ylab = "Endring i Kaclforbruk i FA") + theme(axis.title.x = element_markdown(size = 15))

ggscatter(kor_end, x = "vo2max_ml_min_kg_6x5", y = "phys_act", 
          add = "reg.line", cor.method = "spearman",
          xlab = "Endring i VO<sub>2maks</sub> (ml/kg/min)", ylab = "Endring i Kacl/uke i FA") + theme_clean(base_size = 17) + theme(axis.title.x = element_markdown(size = 15))
