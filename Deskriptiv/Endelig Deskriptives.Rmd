...
select(id,time,group,sex,age, sys, bmi, dia, wc, handgrip, height, weight, vo2max_ml_min_kg_6x5, vo2max_ml_min_6x5, lean_mass, fat_mass, one_rm_newton) %>%
  ...
  filter(time == "pre")%>%
  print(n=38)#filterer ut post for å bare få pre-tester#Velger variabler
...
summarise(m = mean(value, na.rm = TRUE),
          s = sd(value, na.rm = TRUE)) %>%  #summerer og får gjennomsnitt og standartdavik på de ulike variablene 
 #setter "group" og "sex" sammen
