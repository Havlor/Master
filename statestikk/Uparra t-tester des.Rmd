...
data_kom <- read_excel("data/Revidert_resultatskjema.xlsx", na = "NA") #Henter data
data_kom %>%
...
```{r setup, include=FALSE}
data_k <- read_excel("data/Revidert_resultatskjema.xlsx", na = "NA") #Henter data
data_k %>%
select(id,time,group,sex,age, sys, bmi, dia, wc, handgrip, height, weight, vo2max_ml_min_kg_6x5, vo2max_ml_min_6x5, lean_mass, fat_mass, one_rm_newton) %>%
...
data_m <- read_excel("data/Revidert_resultatskjema.xlsx", na = "NA") #Henter data
data_m %>%
select(id,time,group,sex,age, sys, bmi, dia, wc, handgrip, height, weight, vo2max_ml_min_kg_6x5, vo2max_ml_min_6x5, lean_mass, fat_mass, one_rm_newton) %>%
  group_by(group) %>% # grupperer etter kjønn og FLS/kontroll
  filter(time == "pre") %>%
